    ...
    class Customsynergiesknives
    {
        ...
        public class Banana : AdvancedSynergyEntry
        {
            public Banana()
            {
                ...
                this.OptionalGunIDs = new List<int>
                {
                    PickupObjectDatabase.GetByEncounterName("Banana").PickupObjectId,
        ...
        public class BarrelBros : AdvancedSynergyEntry
        {
            public BarrelBros()
            {
                ...
                this.OptionalGunIDs = new List<int>
                {
                    PickupObjectDatabase.GetByEncounterName("Barrel").PickupObjectId,
                    PickupObjectDatabase.GetByEncounterName("Monkey Barrel").PickupObjectId,

                    PickupObjectDatabase.GetByEncounterName("Monkey Barrel ak").PickupObjectId,
